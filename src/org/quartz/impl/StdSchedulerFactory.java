...
public class StdSchedulerFactory implements SchedulerFactory {
    ...
    private Scheduler instantiate() throws SchedulerException {
        ...
        // xuzhou Get ThreadPool Properties
        ...
        // xuzhou Get JobStore Properties 配置文件配的类名称用反射创建对象
        ...
        try {
            ...
            // xuzhou 创建的对方放到QuartzSchedulerResources中并把线程池起来，这个相当于 QuartzScheduler 的资源存放处
